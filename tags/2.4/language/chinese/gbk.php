...
$lan = Array
	...
	'item_edit' => '编辑文章',
	'item_no' => '没有符合条件的文章',
	'specialpage_no' => '还没有创建专题页',
	'item_new' => '增加新文章',
	'item_manage' => '管理文章',
	'specialpages_manage' => '管理专题',
	'specialpage_edit' => '编辑专题',
	'pagename' => '专题名',
	'allcategory' => '所有栏目',
	'allsection' => '所有主题',
	'pagenum' => '页数',
	...
	'pagepathroot' => '专题的文件名必须是绝对路径，即：以根目录“/”开始',
	'haveattach' => '有附件',
	'havepicture' => '有缩略图',
	'attachnum' => '增加附件数',
	'newpage' => '增加一个专题',
	...
	'system_customdic' => '自定义关键字',
	'setting' => '系统设置',
	'system_specialpage' => '管理专题',
	...
	'autoparsekeywords_title' => '自动分析关键字(测试中功能)',
	...
	'spider' => '采集',
	'customdic' => '自定义关键字词库',
	'customdic_description' => '列表中的词会被优先看作是关键字，一行一个词',
	'skipdic' => '排除关键字词库',
	'skipdic_description' => '列表中的词不会被当作关键字，一行一个词',
	...
	'searchtemplate' => '搜索模板',
	'othertemplate' => '其他模板',
	'categorydescription' => '默认网站首页模板为page_home.htm<br>默认内容页模板为item_display.htm<br>默认栏目首页模板为category_home.htm<br>默认栏目列表页模板为category_list.htm<br>默认搜索结果模板为search_list.htm<br>创建新模板时不需要写前缀，只要选择好类型就可以了，不知道选什么类型的一律选“专题页模板”',
	'attachmethod' => '附件存储地址',
